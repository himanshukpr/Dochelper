        ...
        {pdfTools.map((tool, index) => (
          <motion.div
            ...
            onClick={() => {
              ...
              if (tool.title === 'PDF Compress') navigate('/compress-pdf');
              if (tool.title === 'Image to PDF') navigate('/image-to-pdf');
              if (tool.title === 'PDF to Image') navigate('/pdf-to-image');
              if (tool.title === 'Protect PDF') navigate('/protect-pdf');
              if (tool.title === 'Unprotect PDF') navigate('/unprotect-pdf');
            }}
            whileHover={{
              y: -4,
              scale: 1.02,
