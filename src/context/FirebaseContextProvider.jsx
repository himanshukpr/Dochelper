...
import { addDoc, collection, getDocs, getFirestore, deleteDoc, doc, query, where, updateDoc } from "firebase/firestore";
...
export const FirebaseProvider = (props) => {
    ...
    // to update a task
    const updateTaskList = async (taskId, updatedTask) => {
        try {
    ...
    // to update a note
    const updateNote = async (noteid, title, noteContent) => {
        try {
    ...
    return (
        <FirebaseContext.Provider value={{ signup, user, logout, signin, setTaskList, getTaskList, deleteTaskList, setNotes, getNotes, deleteNote, updateNote, updateTaskList }}>
            {props.children}
